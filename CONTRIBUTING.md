Contributing to TOTEM Core
============================

The TOTEM Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TOTEM Core project, and is not to be
confused with overall TOTEM Network Protocol consensus changes.

Whether a pull request is merged into TOTEM Core rests with the project merge
...
Patches that change TOTEM consensus rules are considerably more involved than
...
Where a patch set proposes to change the TOTEM consensus, it must have been
...
The project leader is the release manager for each TOTEM Core release.
