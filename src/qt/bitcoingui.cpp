                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TOTEM Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TOTEM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and totem: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTOTENX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TOTEM Core"), this);
    aboutAction->setStatusTip(tr("Show information about TOTEM Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TOTEM"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TOTEM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TOTEM addresses"));
    ...
    openAction->setStatusTip(tr("Open a TOTEM: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TOTEM Core help message to get a list with possible TOTEM command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TOTEM Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TOTEM network", "", count));
}
...
{
    QString strTitle = tr("TOTEM Core"); // default title
