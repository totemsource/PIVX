...
/** Utility functions used by the TOTEM Qt UI.
 */
namespace GUIUtil
{
...
// Render TOTEM addresses in monospace font
...
// Parse "totem:" URI into recipient object, return true on successful parsing
