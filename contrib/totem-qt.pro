...
RESOURCES += src/qt/totem.qrc src/qt/totem_locale.qrc

TRANSLATIONS += src/qt/locale/totem_bg.ts \
                src/qt/locale/totem_de.ts \
                src/qt/locale/totem_en.ts \
                src/qt/locale/totem_es.ts \
                src/qt/locale/totem_fi.ts \
                src/qt/locale/totem_fr.ts \
                src/qt/locale/totem_it.ts \
                src/qt/locale/totem_ja.ts \
                src/qt/locale/totem_pl.ts \
                src/qt/locale/totem_pt.ts \
                src/qt/locale/totem_ru.ts \
                src/qt/locale/totem_sk.ts \
                src/qt/locale/totem_sv.ts \
                src/qt/locale/totem_vi.ts \
                src/qt/locale/totem_zh_CN.ts \
                src/qt/locale/totem_zh_TW.ts
