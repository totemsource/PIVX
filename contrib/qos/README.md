...
This means one can have an always-on totemd instance running, and another local totemd/totem-qt instance which connects to this node and receives blocks from it.
