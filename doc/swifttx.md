...
This mechanism has been integrated into Bitcore-Node-TOTEM which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TOTEM-Project/insight-api-totem#web-socket-api](https://github.com/TOTEM-Project/insight-api-totem#web-socket-api) 
* API: [https://github.com/TOTEM-Project/insight-api-totem#swifttx-transactions](https://github.com/TOTEM-Project/insight-api-totem#swifttx-transactions) 
...
By default, the TOTEM Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TOTEM Core daemon:
