...
In order to support loading of multiple wallets in totem-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is totem.cpp.
...
Changes to totem.cpp
----------------------
totem.cpp is the entry point into totem-qt, and as such, will require some minor modifications to provide hooks for
